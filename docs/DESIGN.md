# Architecture Decision Record - Data backup and point-in-time recovery
...
Implement Data backup and point-in-time recovery using industry-standard patterns appropriate for python and our platform requirements.
